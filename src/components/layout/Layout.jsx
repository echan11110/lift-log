  ...
  return (
    <div className="flex flex-col min-h-dvh bg-surface">
      <header className="flex items-center justify-between px-4 py-3 bg-card border-b border-border sticky top-0 z-30">
        <span className="text-white font-bold text-lg tracking-tight">Lift Log</span>
        <button
          onClick={signOut}
          className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors px-3 py-1.5 rounded-lg border border-border"
        >
          Sign out
        </button>
      </header>
